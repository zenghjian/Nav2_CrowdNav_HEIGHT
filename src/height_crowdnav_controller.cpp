...
#include "nav2py_crowdnav_height_controller/height_crowdnav_controller.hpp"
...
namespace nav2py_crowdnav_height_controller
{

void HeightCrowdNavController::configure(
  ...
  const std::shared_ptr<nav2_costmap_2d::Costmap2DROS> costmap_ros)
{
  ...
  // Initialize nav2py
  std::string nav2py_script = ament_index_cpp::get_package_share_directory("nav2py_crowdnav_height_controller") + "/../../lib/nav2py_crowdnav_height_controller/nav2py_run" ;
  ...
  RCLCPP_INFO(
    logger_,
    "Configured controller: %s of type nav2py_crowdnav_height_controller::HeightCrowdNavController",
    plugin_name_.c_str());
}

void HeightCrowdNavController::sendCostmapAndPose(
...
void HeightCrowdNavController::cleanup()
{
  RCLCPP_INFO(
    logger_,
    "Cleaning up controller: %s of type nav2py_crowdnav_height_controller::HeightCrowdNavController",
    plugin_name_.c_str());
  nav2py_cleanup();
  global_pub_.reset();
}

void HeightCrowdNavController::activate()
{
  RCLCPP_INFO(
    logger_,
    "Activating controller: %s of type nav2py_crowdnav_height_controller::HeightCrowdNavController\"  %s",
    plugin_name_.c_str(),plugin_name_.c_str());
  global_pub_->on_activate();
}

void HeightCrowdNavController::deactivate()
{
  RCLCPP_INFO(
    logger_,
    "Dectivating controller: %s of type nav2py_crowdnav_height_controller::HeightCrowdNavController\"  %s",
    plugin_name_.c_str(),plugin_name_.c_str());
  global_pub_->on_deactivate();
}

void HeightCrowdNavController::setSpeedLimit(const double& speed_limit, const bool& percentage)
{
  (void) speed_limit;
  (void) percentage;
}

geometry_msgs::msg::TwistStamped HeightCrowdNavController::computeVelocityCommands(
 const geometry_msgs::msg::PoseStamped & pose,
 const geometry_msgs::msg::Twist & velocity,
...
void HeightCrowdNavController::setPlan(const nav_msgs::msg::Path & path)
{
...
nav_msgs::msg::Path
HeightCrowdNavController::transformGlobalPlan(
  const geometry_msgs::msg::PoseStamped & pose)
{
...
bool HeightCrowdNavController::transformPose(
...
PLUGINLIB_EXPORT_CLASS(nav2py_crowdnav_height_controller::HeightCrowdNavController, nav2_core::Controller) 